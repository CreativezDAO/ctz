...
function BeforePublicsale() {
    ...
    const startTimer = () => {
        const countdownDate = new Date('December 17, 2022 00:00:00').getTime();
  ...
  return (
    <Wrap>
      ...
      <Timer>
      <p1 className = "p17">COUNTDOWN TO PUBLIC SALE</p1> 
      <TimerBoxes>
...
export default BeforePublicsale
